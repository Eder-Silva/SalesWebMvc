...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //Seed é operação responsável por popular o bd
        public void Seed()
        {
            //se existir algum dado na bd,interromperá a operação
            //ou seja db has heen seeded(bd já foi populado)
            ...
            //se bd não foi populado, irá ser populado agora
